...
https://iEndorseWhomever.com/?firstname=Bernie&where=Burlington,+VT&reason=4&test=1

You'd specify (with spaces escaped to "+") values for firstname, where, reason (a number, starting with 1, corresponding to the choice). You can also specify test=1 to allow the avatar upload to be bypassed and a placeholder used instead. This makes testing much easier
